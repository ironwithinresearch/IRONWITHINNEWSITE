    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg-dark)', padding: '60px 24px 90px' }}>
      <div className="container" style={{ maxWidth: 940 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '44px' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(2rem,5vw,3rem)', fontWeight: 900, color: '#fff', margin: '0 0 12px' }}>TWR Rewards</h1>
...
const DEFAULT_TIERS = [
  { key: 'iron', name: 'Iron', min: 0, perks: ['1 point per $1 spent', '250-point welcome bonus'] },
  { key: 'steel', name: 'Steel', min: 3000, perks: ['1.25 points per $1 (1.25×)'] },
  { key: 'titanium', name: 'Titanium', min: 10000, perks: ['1.5 points per $1 (1.5×)', 'Free U.S. shipping', 'Early access to restocks & drops'] },
  { key: 'black', name: 'Black Label', min: 25000, perks: ['2 points per $1 (2×)', 'Free U.S. shipping', 'Early access to drops', 'Birthday bonus points'] },
];
