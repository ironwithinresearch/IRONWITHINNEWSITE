...
const sections = [
  {
    ...
    content:
      'By accessing and using the Titanium Within Research website, you agree to comply with and be bound by these Terms & Conditions. If you do not agree with any part of these terms, you should discontinue use of the website immediately.',
  },
  {
    title: 'Research Use Only',
    content:
      'All products sold by Titanium Within Research are intended solely for laboratory and research purposes. Products are not intended for human consumption, medical use, veterinary use, diagnosis, treatment, or prevention of any disease.',
  },
  {
    title: 'Eligibility',
    content:
  ...
  },
  {
    ...
    content:
      'Titanium Within Research shall not be liable for any indirect, incidental, consequential, or special damages arising from the use of our products or website.',
  },
  {
    title: 'Intellectual Property',
    content:
      'All content on this website, including logos, graphics, text, and designs, is the property of Titanium Within Research and may not be reproduced without permission.',
  },
  {
