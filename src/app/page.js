        ...
        <div className="container" style={{ maxWidth: 1000 }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '32px', alignItems: 'center', background: 'var(--card-dark)', border: '1px solid rgba(0,207,255,0.3)', borderRadius: '24px', padding: '32px', boxShadow: '0 0 0 1px rgba(0,207,255,0.05), 0 20px 60px rgba(0,0,0,0.3)' }}>
            <div style={{ flex: '1 1 280px', minWidth: 240 }}>
              <img src="https://bhidasowgm.onrocket.site/wp-content/uploads/2026/06/hf_20260620_021027_f56e3d66-2336-4448-81c1-f93ec0aa298e.png" alt="The Grand Slam Bundle" style={{ width: '100%', borderRadius: '16px', display: 'block' }} />
            </div>
            <div style={{ flex: '1 1 320px' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: 1.6, margin: '0 0 18px' }}>
                Our 3 most-ordered research peptide sets in one — <strong style={{ color: 'var(--text-light)' }}>GLOW</strong> + <strong style={{ color: 'var(--text-light)' }}>CJC/IPA</strong> (10+10) + <strong style={{ color: 'var(--text-light)' }}>BPC-157/TB-500</strong> (10+10). 99%+ purity, COA on every vial.
              </p>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', flexWrap: 'wrap', marginBottom: '20px' }}>
                <span style={{ fontFamily: 'var(--font-heading)', fontSize: '2.1rem', fontWeight: 900, background: 'var(--gradient-primary)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>$176.33</span>
                <span style={{ color: 'var(--text-muted)', fontSize: '1.1rem', textDecoration: 'line-through' }}>$251.90</span>
                <span style={{ padding: '4px 12px', background: 'rgba(52,211,153,0.14)', border: '1px solid rgba(52,211,153,0.35)', borderRadius: '999px', fontSize: '0.78rem', fontWeight: 800, color: '#34d399' }}>Save 30% · $75.57</span>
              </div>
