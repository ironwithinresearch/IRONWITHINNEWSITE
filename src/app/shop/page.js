                ...
                return (
                  <div key={product.id} style={{ background: 'var(--card-dark)', border: '1px solid var(--glass-border)', borderRadius: '16px', overflow: 'hidden', display: 'flex', flexDirection: 'column', transition: 'all 0.2s ease', position: 'relative' }}
                    ...
                    <button
                      ...
                      onMouseEnter={e => { e.currentTarget.style.background = 'rgba(236,72,153,0.15)'; e.currentTarget.style.borderColor = 'rgba(236,72,153,0.5)'; e.currentTarget.style.color = 'var(--pink, #ec4899)'; }}
                      onMouseLeave={e => { if (!wishlisted) { e.currentTarget.style.background = 'rgba(5,7,18,0.55)'; e.currentTarget.style.borderColor = 'var(--glass-border)'; e.currentTarget.style.color = 'var(--pink, #ec4899)'; } }}>
