...
import {
  ...
  Loader2, ChevronRight, Filter, AlertCircle,
  CheckCircle2,
} from 'lucide-react';
    ...
    <div style={{ minHeight: '100vh', paddingBottom: '80px' }}>
      ...
      {notification && (
        <div style={{
          ...
          padding: '12px 20px',
          background: notification.type === 'error' ? 'rgba(239,68,68,0.95)' : 'rgba(52,211,153,0.95)',
          borderRadius: '10px', color: '#fff', fontWeight: 600, fontSize: '0.875rem',
      ...
      <div className="container">
        ...
        <form onSubmit={handleSearch} style={{
          display: 'flex', gap: '10px', marginBottom: '32px', maxWidth: '520px',
        }}>
          ...
          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '32px' }}>
            <button
              ...
              style={{
                ...
                background: !activeCategory ? 'var(--gradient-primary)' : 'var(--card-dark)',
                color: !activeCategory ? '#fff' : 'var(--text-secondary)',
                fontFamily: 'var(--font-body)', fontSize: '0.82rem', fontWeight: 600,
                cursor: 'pointer',
                border: !activeCategory ? 'none' : '1px solid var(--glass-border)',
              }}
            >All</button>
            {categories.map(cat => (
              <button
                ...
                style={{
                  ...
                  background: activeCategory === cat.slug ? 'var(--gradient-primary)' : 'var(--card-dark)',
                  color: activeCategory === cat.slug ? '#fff' : 'var(--text-secondary)',
                  fontFamily: 'var(--font-body)', fontSize: '0.82rem', fontWeight: 600,
                  cursor: 'pointer',
                  border: activeCategory === cat.slug ? 'none' : '1px solid var(--glass-border)',
                }}
              >
                  ...
                  >
                      ...
                      <div style={{
                        ...
                        {!inStock && (
                          <div style={{
                            ...
                            border: '1px solid rgba(239,68,68,0.3)',
                            borderRadius: '999px', fontSize: '0.68rem', fontWeight: 600, color: '#f87171',
                          }}>Out of Stock</div>
                        )}
                        {isVariable && (
                          <div style={{
                            ...
                            borderRadius: '999px', fontSize: '0.68rem', fontWeight: 600, color: 'var(--purple)',
                          }}>Options</div>
                        )}
                      </div>
                    </Link>
                    ...
                    <div style={{ padding: '18px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto', gap: '10px' }}>
                        <span style={{
                          fontFamily: 'var(--font-heading)', fontWeight: 900, fontSize: '1.15rem',
                          background: 'var(--gradient-primary)',
                          WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text',
                        }} dangerouslySetInnerHTML={{ __html: product.price || 'View Product' }} />
                        ...
                        {isVariable ? (
                          ...
                          <button
                            ...
                            style={{
                              display: 'flex', alignItems: 'center', gap: '5px',
                              padding: '8px 14px',
                              background: added ? 'rgba(52,211,153,0.15)' : inStock ? 'var(--gradient-primary)' : 'var(--card-elevated)',
                              border: added ? '1px solid rgba(52,211,153,0.4)' : 'none',
                              borderRadius: '8px',
                              color: added ? '#34d399' : inStock ? '#fff' : 'var(--text-muted)',
                              fontWeight: 600, fontSize: '0.8rem', cursor: inStock ? 'pointer' : 'not-allowed',
                              fontFamily: 'var(--font-body)',
