...
import { Copy, Check, Sparkles, ShieldAlert, ShieldCheck, ArrowRight } from 'lucide-react';
...
function Snippet({ text }) {
  ...
  return (
    <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', background: 'var(--card-dark)', border: '1px solid var(--glass-border)', borderRadius: 12, padding: '14px 16px' }}>
      <p style={{ flex: 1, color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: 1.55, margin: 0 }}>{text}</p>
