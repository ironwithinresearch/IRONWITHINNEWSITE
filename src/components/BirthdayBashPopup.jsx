  ...
  return (
    <div onClick={dismiss}
      ...
      <div onClick={(e) => e.stopPropagation()}
        style={{ position: 'relative', width: '100%', maxWidth: 440, background: 'var(--card-dark)', border: '1px solid rgba(74,222,128,0.45)', borderRadius: 18, overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.6)' }}>
        ...
        <div style={{ padding: '18px 20px 22px', textAlign: 'center' }}>
          <Link href="/shop" onClick={dismiss}
            style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '100%', boxSizing: 'border-box', padding: '14px', background: 'linear-gradient(90deg,#4ade80,#f5d272)', borderRadius: 10, color: '#0a0a0a', fontWeight: 800, fontSize: '1rem', textDecoration: 'none' }}>
