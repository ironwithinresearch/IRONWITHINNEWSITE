...
export default function GuaranteeBadge({ style = {} }) {
  return (
    <div style={{ background: 'var(--card-dark)', border: '1px solid rgba(168,85,247,0.28)', borderRadius: '16px', padding: '20px 22px', boxShadow: '0 0 0 1px rgba(168,85,247,0.04), 0 10px 30px rgba(0,0,0,0.25)', ...style }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '14px' }}>
        <div style={{ flexShrink: 0, width: 46, height: 46, borderRadius: '12px', background: 'rgba(168,85,247,0.12)', border: '1px solid rgba(168,85,247,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
