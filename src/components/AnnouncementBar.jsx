  ...
  return (
    <div
      ...
      style={{
        ...
        background: j4Active ? 'linear-gradient(90deg,#b22234,#7a1228,#13294b,#7a1228,#b22234)' : bbActive ? 'linear-gradient(90deg,#ec4899,#f5d272)' : 'var(--gradient-primary, linear-gradient(90deg,#00CFFF,#7c3aed))',
        color: j4Active ? '#fff' : '#001018', overflow: 'hidden', display: 'flex', alignItems: 'center',
